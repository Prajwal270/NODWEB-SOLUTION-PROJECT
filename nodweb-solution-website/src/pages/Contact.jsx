    ...
    <main className="bg-[#05070F] text-white min-h-screen">
      <section className="max-w-7xl mx-auto px-6 py-12 md:py-20">
        ...
        <div className="grid gap-6 sm:gap-8 md:grid-cols-2 items-start">
            ...
            <div className="p-4 md:p-6 rounded-lg bg-[rgba(255,255,255,0.02)]">
              ...
              <div className="mt-4">
                <button
                  ...
                  className="block md:inline-flex w-full md:w-auto text-center items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-md"
                >
                  Visit our Job Board
                </button>
              </div>
            ...
            <div className="p-6 rounded-lg bg-[rgba(255,255,255,0.02)] flex items-center gap-4">
              <div className="flex-1">
                ...
                <p className="text-gray-300 mt-2">
                  Explore internships and full-time roles. We hire driven
                  learners and team players.
                </p>
              </div>
              <div>
                <a
                  href="/career"
                  className="block md:inline-flex w-full md:w-auto text-center items-center gap-2 px-3 py-2 bg-transparent border border-indigo-600 text-indigo-400 rounded"
                >
                  View Openings
                </a>
              </div>
            ...
            <div className="p-6 rounded-lg bg-[rgba(255,255,255,0.02)]">
              ...
              <div className="mt-4">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="block md:inline-flex w-full md:w-auto items-center gap-3 bg-green-500 px-4 py-2 rounded text-white text-center"
                >
                  <svg
          ...
          <div>
            <div
              className="bg-gradient-to-br from-[#07264b] to-[#0b3a6a] p-4 md:p-6 rounded-lg shadow-lg border"
              ...
              <form onSubmit={handleSubmit} className="grid gap-3">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-3">
                  <label className="block">
                    ...
                    <input
                      ...
                      required
                      className="w-full px-3 py-3 rounded bg-transparent border border-gray-600 focus:outline-none transition-all duration-200 ease-in-out text-white placeholder-gray-400"
                    />
                  </label>
                  ...
                  <label className="block">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-3 rounded bg-transparent border border-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition text-white placeholder-gray-400"
                    />
                ...
                <label className="block relative" ref={expertiseRef}>
                  ...
                  <div
                    ...
                    className="w-full px-3 py-3 rounded bg-[rgba(255,255,255,0.02)] text-white border border-gray-600 focus:outline-none flex items-center justify-between cursor-pointer transition-all duration-200 ease-in-out"
                  >
                    <span>
                      {selectedExpertise
                    ...
                    <div className="absolute left-0 right-0 mt-1 bg-[#071129] border border-gray-700 rounded shadow-lg max-h-48 overflow-auto z-50">
                      {EXPERTISE_OPTIONS.map((opt) => (
                        <div
                          ...
                          className="px-3 py-2 hover:bg-indigo-700 cursor-pointer text-white transition-all duration-200 ease-in-out"
                        >
                          {opt.label}
                        </div>
                      ))}
                ...
                <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
                  <button
                    ...
                    className="w-full md:w-auto px-6 py-3 rounded-md font-medium text-white transition transform hover:scale-[1.01] focus:outline-none focus:ring-2 focus:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
        ...
        <section className="mt-12">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div
              ref={mapRef}
              className="relative rounded-xl overflow-hidden border border-indigo-700/10 bg-gradient-to-br from-[#041229]/40 to-[#06203a]/40 shadow-lg"
            >
              ...
              {mapVisible ? (
                ...
                <div className="w-full h-64 md:h-96 bg-gradient-to-br from-[#061a39] to-[#07284b] flex items-center justify-center text-gray-400">
